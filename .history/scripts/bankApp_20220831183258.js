const hre = require("hardhat");
    ...
    async function main() {
      ...
      await bankApp.connect(account0).login();
       console.log(signers[0].address);
        await bankApp.connect(account0).deposit(100);
        console.log( await bankApp.connect(signers[0]) .checkBalance("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266"))
       ;
